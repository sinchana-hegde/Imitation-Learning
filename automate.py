...
while True:
    ...
    if os.path.isfile(file_name):
        ...
        #training_data = []
        opt = 'rostopic echo -p /bebop/odom > /home/sinchana-h/Desktop/alluBhindi/odom_final{}.txt'.format(starting_value)
        pyautogui.hotkey('ctrl', 'alt', 't')
...
while True:
    ...
    if os.path.isfile(file_name):
        ...
        #print('File does not exist, starting fresh!',starting_value)
        #training_data = []
        opt = 'rostopic echo -p /bebop/fix > /home/sinchana-h/Desktop/alluBhindi/gps_final{}.txt'.format(starting_value)
        pyautogui.hotkey('ctrl', 'alt', 't')
        pyautogui.typewrite(opt)
        pyautogui.hotkey('enter')
        break
...
pyautogui.hotkey('ctrl', 'alt', 't')
pyautogui.typewrite('cd ~/Desktop/alluBhindi')
pyautogui.hotkey('enter')
